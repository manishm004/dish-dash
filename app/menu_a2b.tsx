...
export default function MenuSubway() {
  ...
  const restaurantId = 2; // Hardcoded for KFC; change as needed for other restaurants
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        const resMenu = await fetch('https://x0r7l4fplb.execute-api.eu-north-1.amazonaws.com/prod/2');
